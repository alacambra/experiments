...
var RestServices = function(endpoint) {
    ...
    this.budgetRestServices = function($http) {
    ...
    this.individualCostService = function($http) {
...
//                    .then(that.budgetRestServices($http).getBudgetsForYear(callback)).
                    success(function(data) {
                        buffer["get"][year] = data;
                        callback(data);
                    }).error(function(data, status, headers, config) {
    ...
    this.periodicCostService = function($http) {
    ...
    return {
        "bufferRestServices":this.bufferRestServices,
        "individualCostService":this.individualCostService,
        "periodicCostService":this.periodicCostService
    };
};